...
![wireframe of page design](public/resources/bibliobibuli-wireframe.png)
...
- using middleware
  ...
  - `const r = await fetch ('/fav/ringo', { method: 'DELETE' });` matches `app.delete(/fav\/(.*)/, () => {})` 
...
- JSX purposes:
  1. to inject your HTML into your JavaScript
  2. to componentize your HTML
  3. to allow for composability of your HTML
